...
## 錡興水質監控系統
監測進流(原水)、放流、製程中的水質，分析水質在製程中的變化，並提供即時監測數值、歷史資料、警告通知等功能。額外監測泵浦、電動閥訊號。
...
![錡興水質監控頁面](image/錡興水質監控系統-首頁.png)

## 海外專案範例網站
展示公司核心服務、監測產品、網站設計、功能實作等，提供海外客戶參考。
監測多項水質項目，與傳輸設備狀態，提供即時監測數值、歷史資料、警告通知等功能。
...
| 專案名稱         | 狀態   | 網址             |
| ---------------- | ------ | ---------------- |
| 海外專案範例網站 | 使用中 | 僅供公司業務使用 |

![OverSeas-IOT-Monitor-首頁](image/OverSeas-IOT-Monitor-首頁.png)